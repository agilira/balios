...
function Invoke-Help {
    ...
    Write-ColorOutput "  fuzz          Run fuzz tests (quick - 30 sec each, ~3.5 min total)" $Green
    Write-ColorOutput "  fuzz-extended Run fuzz tests (extended - 5 min each, ~35 min total)" $Green
